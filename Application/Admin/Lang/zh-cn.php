...
return array(
    ...
    'menu_info_name' => '信息中心',
    'menu_sort_name' => '文章分类',
    'menu_sort_list' => '文章分类列表',
    'menu_sort_add' => '添加文章分类',
    'menu_news_name' => '文章管理',
    'menu_news_list' => '文章列表',
    'menu_news_list_add' => '添加文章',
    'menu_news_recycle' => '文章回收站',
    ...
    'menu_block_cat' => '碎片分类',
    'menu_doc_name' => '手册列表',
    'menu_doc_sort_name' => '手册分类',
    'menu_doc_sort_list' => '手册分类列表',
    'menu_doc_sort_add' => '添加手册分类',
    'menu_doc_list' => '手册内容列表',
    'menu_doc_list_suoyin' => '手册索引列表',
    'menu_doc_recycle' => '手册回收站',
    //用户管理
    'menu_user_name' => '用户管理',
