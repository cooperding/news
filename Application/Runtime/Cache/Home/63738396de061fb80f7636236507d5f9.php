        ...
        <div class="dogo-page ">
            <div class="container">
                <header class="dogo-header">
                    <div class="row">
                        <div class="col-md-2">
                            <img src="/qiuyun/dogocms32/Public<?php echo ($style); ?>/images/logo.gif" class="img-responsive"/>
                        </div>
                        <div class="col-md-7">
    ...
    <div class="col-md-8">
        ...
        <section class="dogo-box dogo-border-all dogo-pd515">
            ...
            <div class="dogo-box-footer">
                ...
                <textarea name="content-comment" class="form-control disabled" rows="3"></textarea>
                <br/>
