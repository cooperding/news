    ...
    <div class="col-md-4">
        ...
        <aside class="dogo-box dogo-border-all dogo-pd515">
            ...
            <div class="dogo-box-content dogo-links">
                ...
                <?php $_result=M('Links')->limit(0,10)->where(" (`status`='20') ")->select(); if ($_result): $i=0;foreach($_result as $key=>$links):++$i;$mod = ($i % 2 );?><a href=""><?php echo ($links["webname"]); ?></a><?php endforeach; endif;?>
            </div><!--dogo-box-content-->
            <div class="dogo-box-footer">
