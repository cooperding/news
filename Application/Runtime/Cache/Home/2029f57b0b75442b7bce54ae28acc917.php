    ...
    <div class="col-md-4">
        ...
        <aside class="dogo-box dogo-border-all dogo-pd515">
            ...
            <div class="dogo-box-content">
                <span class="glyphicon glyphicon-user"></span> <?php echo ($members_data["username"]); ?>
                <span class="glyphicon glyphicon-time"></span> <?php echo (date("Y-m-d",$members_data["addtime"])); ?>
