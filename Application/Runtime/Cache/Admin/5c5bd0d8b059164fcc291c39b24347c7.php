<?php if (!defined('THINK_PATH')) exit();?><table  id="datagrid_operators" class="datagrid">
</table>
<script>
    $(function() {
        var height = $('.indexcenter').height();
        var classId = 'operators';
        var hrefadd = '<?php echo U("Admin/Operators/add");?>';
        var hrefedit = '<?php echo U("Admin/Operators/edit");?>';
        var hrefcancel = '<?php echo U("Admin/Operators/edit");?>';
        var urljson = '<?php echo U("Admin/Operators/listJsonId",array("id"=>$id));?>';
        ...
        $('#datagrid_' + classId).datagrid({
            ...
            columns: [[
                    ...
                    {field: 'creat_time', title: '添加时间', width: 200},
