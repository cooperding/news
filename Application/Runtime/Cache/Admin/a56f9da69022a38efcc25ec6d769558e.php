<?php if (!defined('THINK_PATH')) exit();?><table  id="datagrid_orderlist" class="datagrid">
...
<script>
    ...
    $(function() {
        ...
        var hrefadd = '<?php echo U("Admin/OrderList/add");?>';
        var hrefedit = '<?php echo U("Admin/OrderList/edit");?>';
        var hrefcancel = '<?php echo U("Admin/OrderList/delete");?>';
        var urljson = '<?php echo U("Admin/OrderList/listJsonId");?>';
            ...
            columns: [[
                    ...
                    //{field:'parent_id',title:'parent_id',width:200},
                    {
                        ...
                        formatter: function(value, row, index) {
                            return '<img class="btn_do" src="/qiuyun/dogocms32/Public/Easyui/themes/icons/pencil.png" onclick="ding_edit(\'' + hrefedit + '?id=' + row.id + '\',\'' + classId + '\')"  title="订单管理"/>&nbsp;\n\
