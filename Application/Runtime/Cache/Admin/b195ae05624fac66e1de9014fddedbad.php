...
<div class="easyui-layout layout_goodslist">
    <div data-options="region:'west',split:true" title="商品分类" style="width:150px;">
        <ul class="easyui-tree tree_goodslist" data-options="url:'<?php echo U('Admin/GoodsSort/jsonSortTree');?>'" style="padding: 10px 5px;">
            <!--
            ...
            $(function() {
                ...
                $('.tree_' + classId).tree({
                    onClick: function() {
                        ...
                        var url = '/qiuyun/dogocms32/admin/GoodsList/newslist/id/'+nid;
