<?php if (!defined('THINK_PATH')) exit();?><table  id="datagrid_adstab<?php echo ($id); ?>" class="datagrid">
...
<script>
    $(function() {
        ...
        var classId = 'adstab<?php echo ($id); ?>';
        var hrefadd = '<?php echo U("Admin/Ads/add");?>';
        var hrefedit = '<?php echo U("Admin/Ads/edit");?>';
        var hrefcancel = '<?php echo U("Admin/Ads/delete");?>';
        var urljson = '<?php echo U("Admin/Ads/listJsonId",array("id"=>$id));?>';
