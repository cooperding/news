<?php if (!defined('THINK_PATH')) exit();?><table  id="datagrid_goodsoutstock" class="datagrid">
...
<script>
    $(function() {
        ...
        var classId = 'goodsoutstock';
        //var hrefrevert = '__GROUP__/GoodsList/recycleRevert';
        var hrefedit = '<?php echo U("Admin/GoodsList/edit",array("id"=>$id));?>';
        var hrefcancel = '<?php echo U("Admin/GoodsList/deleteRec",array("id"=>$id));?>';
        var urljson = '<?php echo U("Admin/GoodsList/listJsonId",array("id"=>$id,"is_outstock"=>0));?>';
