<?php if (!defined('THINK_PATH')) exit();?><table id="treegrid_goodssort">
...
<script>
    $(function() {
        ...
        var urljson = '<?php echo U("Admin/GoodsSort/json");?>';
        var hrefadd = '<?php echo U("Admin/GoodsSort/add");?>';
        var hrefedit = '<?php echo U("Admin/GoodsSort/edit");?>';
        var hrefcancel = '<?php echo U("Admin/GoodsSort/delete");?>';
