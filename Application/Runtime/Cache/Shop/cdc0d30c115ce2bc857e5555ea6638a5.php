...
<div class="container">
    <div class="row">
        <div class="col-md-9">
            <div class="dogo-box dogo-box-bg ">
                <ul class="bxslider">
                    <?php $_result=M('Ads')->order("myorder asc")->limit(0,4)->where(" (`status`='20')  and (`sort_id` =1) ")->select(); if ($_result): $i=0;foreach($_result as $key=>$ads):++$i;$mod = ($i % 2 );?><li><a href="" title="<?php echo ($ads["name"]); ?>"><img src="<?php echo ($ads["pic"]); ?>" title="<?php echo ($ads["name"]); ?>"/></a></li><?php endforeach; endif;?>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <aside>
                <div class="dogo-box dogo-box-bg dogo-border-all dogo-bg">
...
<div class="container">
    <div class="row dogo-index-row">
        ...
        <div class="dogo-box dogo-box-bg " style="margin-top: 0px;">
            <section class="dogo-section dogo-rgba-blue">

                <?php $_result=M('BlockList')->order("myorder asc")->limit(12)->where(" (`status`='20')  and (`sort_id` =4) ")->select(); if ($_result): $i=0;foreach($_result as $key=>$block):++$i;$mod = ($i % 2 );?><div class="col-md-3">
                        <div class="dogo-index-thumb">
                            ...
                            <div class="dogo-thumb-title">
                                ...
                                <span class="dogo-align-center">
                                    <a id="section6Btn" href="<?php echo ($block["url"]); ?>">查看信息>></a></span>
                            </div>
                        </div>
