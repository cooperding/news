...
<div class="container">
    <div class="row dogo-list">
        ...
        <section class="dogo-section dogo-rgba-blue">
            <?php $_result=M('BlockList')->order("myorder asc")->limit(1)->where(" (`status`='20')  and (`sort_id` =4) ")->select(); if ($_result): $i=0;foreach($_result as $key=>$block):++$i;$mod = ($i % 2 );?><div class="col-md-12">
        ...
        <?php if(is_array($list)): foreach($list as $i=>$vo): ?><div class="col-md-3">
                <section class="dogo-box dogo-list-box dogo-border-all dogo-pd515">
                    <div class="dogo-box-header">
                        <?php if($vo["title"] != ''): ?><h4><span class="glyphicon glyphicon-hand-right"></span> <a href="<?php echo U('Home/Content/index',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a></h4><?php endif; ?>
                        <p>
                    ...
                    <div class="dogo-box-content">
                        ...
                        <?php if($vo["titlepic"] != ''): ?><br/>
                            <a href="<?php echo U('Home/Content/index',array('id'=>$vo['id']));?>">
                                <img class="img-responsive" src="<?php echo ($vo["titlepic"]); ?>"/>
                            </a><?php endif; ?>
                        </p>
