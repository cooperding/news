...
<link rel="stylesheet" type="text/css" href="/qiuyun/dogocms32/Public<?php echo ($style_common); ?>/v3.1.1/css/bootstrap-datetimepicker.min.css"/>
<div class="row">
    <div class="col-md-3">
    ...
    <div class="col-md-9">
        <div class="dogo-member">
            ...
            <form class="form-horizontal " role="form" action="<?php echo U('User/Index/doPersonal');?>" method="post">
                <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label input-lg">用户名：</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control input-lg" id="inputName" placeholder="" disabled value="<?php echo ($data["username"]); ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputSex" class="col-sm-2 control-label input-lg">性别：</label>
                    <div class="col-sm-10">
                        <label class="radio-inline">
                            <input type="radio" name="sex" id="inputSex1" value="10" <?php if(($data["sex"]) == "10"): ?>checked<?php endif; ?> >
                            男
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="sex" id="inputSex2" value="11" <?php if(($data["sex"]) == "11"): ?>checked<?php endif; ?>>
                            女
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="sex" id="inputSex3" value="12" <?php if(($data["sex"]) == "12"): ?>checked<?php endif; ?>>
                            保密
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="inputBirthday" class="col-sm-2 control-label input-lg">生日：</label>
                    <div class="col-sm-10">
                        <input type="text" name="birthday" class="form-control input-lg datetimepicker" id="inputBirthday" data-date-format="yyyy-mm-dd" value="<?php echo (date('Y-m-d',$data["birthday"])); ?>" placeholder="生日">
                    </div>
                </div>

                <div class="form-group">
                    <label for="inputSignature" class="col-sm-2 control-label input-lg">个性签名：</label>
                    <div class="col-sm-10">
                        <textarea class="form-control input-lg" name="signature" id="inputSignature" rows="3" placeholder="个性签名"><?php echo ($data["signature"]); ?></textarea>
                    </div>
                </div>
...
<script type="text/javascript" src="/qiuyun/dogocms32/Public<?php echo ($style_common); ?>/v3.1.1/js/bootstrap-datetimepicker.min.js"></script>
</div><!--container-->
</div><!--dogo-page-->
<script>
    $(function() {
