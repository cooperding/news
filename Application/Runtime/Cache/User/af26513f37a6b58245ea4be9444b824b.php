...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="dogo-member">
            ...
            <form class="form-horizontal " role="form" action="<?php echo U('User/Index/newsInsert');?>" method="post">
                <div class="form-group">
                    <label for="inputTitle" class="col-sm-2 control-label">标题：</label>
                    <div class="col-sm-10">
                        <input type="text" name="title" class="form-control input-lg" id="inputTitle" placeholder="">（太麻烦了，标题可以为空！~~~）
                    </div>
                </div><!--form-group-->
                <div class="form-group">
                    <label for="inputContent" class="col-sm-2 control-label">当真内容：</label>
                    <div class="col-sm-10">
                        <textarea class="form-control input-lg" name="content" id="inputContent" rows="9" required="required"
                                  placeholder="填写当真内容"></textarea>
                    </div>
                </div><!--form-group-->
                <div class="form-group">
                    <label for="url1" class="col-sm-2 control-label">图片：</label>
                    <div class="col-sm-10">
                        <input type="text" name="titlepic" class="form-control input-lg" id="url1" placeholder="">
                        <br/>
                        <input name="image" type="button" id="image1" value="选择图片" class="btn btn-default col-lg-12 btn-lg dogo-color-white" />
                    </div>
                </div><!--form-group-->
                <p>
                    注意事项：（投稿须知）<br/>
                    1、自己的或朋友的糗事，真实有笑点，不含政治、色情、广告、诽谤、歧视等内容。<br/>
                    2、糗事经过审核后发表。<br/>
                    3、转载请注明出处。<br/>
                    4、投稿内容著作权、版权归糗事百科网站所有。
                </p>
                <div class="form-group">
                    <div class=" col-sm-12">
...
<script>
    $(function() {
        var editor = KindEditor.editor({
            allowFileManager: false, //隐藏图片空间按钮
            uploadJson: '<?php echo U("User/Index/uploadImg");?>'
        });
        KindEditor('#image1').click(function() {
            editor.loadPlugin('image', function() {
                editor.plugin.imageDialog({
                    //showRemote : false,//隐藏网络图片选项卡
