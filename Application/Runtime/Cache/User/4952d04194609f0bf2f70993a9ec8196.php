...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="dogo-member">
            ...
            <?php if(is_array($list)): foreach($list as $i=>$vo): ?><section class="dogo-box dogo-border-all dogo-pd515 dogo-bg-white">
                    <div class="dogo-box-header">
                        <h5>
                            <?php if($vo["title"] != ''): ?><span class="glyphicon glyphicon-hand-right"></span> 
                                <a href="<?php echo U('Home/Content/index',array('id'=>$vo['id']));?>" target="_blank">
                                    <?php echo ($vo["title"]); ?>
                                </a>
                                &nbsp;&nbsp;<?php endif; ?>
                            <a href="<?php echo U('Home/Content/index',array('id'=>$vo['id']));?>" title="在新页面打开" target="_blank">
                                <span class="glyphicon glyphicon-share"></span> 点击浏览
                            </a>&nbsp;&nbsp;
                            <span class="glyphicon glyphicon-thumbs-up"></span> 
                            (<?php echo ($vo["num_top"]); ?>)&nbsp;&nbsp;
                            <span class="glyphicon glyphicon-thumbs-down"></span> 
                            (<?php echo ($vo["num_beat"]); ?>)&nbsp;&nbsp;
                            <a href="<?php echo U('Home/Content/index',array('id'=>$vo['id']));?>" target="_blank" title="评论">
                                <span class="glyphicon glyphicon-comment"></span> (<?php echo ($vo["num_comment"]); ?>)
                            </a>&nbsp;&nbsp;
                            (<?php echo ($vo["status"]); ?>)
                        </h5>
                    ...
                    <div class="dogo-box-content">
                        <p>
                            <?php echo ($vo["content"]); ?>
                        <?php if($vo["titlepic"] != ''): ?><br/>
                            <a href="<?php echo U('Home/Content/index',array('id'=>$vo['id']));?>"><img class="img-responsive" src="<?php echo ($vo["titlepic"]); ?>"/></a><?php endif; ?>
                        </p>
