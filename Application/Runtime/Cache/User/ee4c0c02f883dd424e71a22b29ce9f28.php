...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="dogo-member">
            <h4> <span class="glyphicon glyphicon-home"></span> <?php echo ($data["uname"]); ?>，欢迎您！</h4>
            <div class="dogo-blank"></div>
            <p><span class="glyphicon glyphicon-time"></span> <?php echo (date("Y年m月d日",$data["addtime"])); ?>加入我们 &nbsp;&nbsp;<span class="glyphicon glyphicon-map-marker"></span> 当前IP：<?php echo ($data["ip"]); ?></p>
            <p>个性签名: <span class="glyphicon glyphicon-hand-right"></span> <?php echo ($data["signature"]); ?></p>
        </div><!--dogo-member-->
    </div><!--col-md-->
</div><!--row-->
