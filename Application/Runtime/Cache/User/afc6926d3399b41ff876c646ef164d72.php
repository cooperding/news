...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="dogo-member">
            ...
            <?php if(($count_address) < "5"): ?><a href="<?php echo U('User/Index/addressAdd');?>"><span class="btn btn-info">添加收货地址</span></a><?php endif; ?>
            <table class="table table-hover table-responsive">
                ...
                <?php if(is_array($list)): foreach($list as $i=>$vo): ?><tr>
                        ...
                        <td>
                    <?php if(($vo["is_default"] == 20)): ?>默认收货地址<?php endif; ?>
                    </td>

                    <td><a href="<?php echo U('User/Index/addressEdit',array('id'=>$vo['id']));?>" title="编辑地址"><span class="glyphicon glyphicon-edit"></span></a> / 
                        <a href="<?php echo U('User/Index/addressDelete',array('id'=>$vo['id']));?>" onclick="return confirm('确认要删除该信息吗？');" title="删除地址"><span class="glyphicon glyphicon-remove-circle"></span></a> </td>
